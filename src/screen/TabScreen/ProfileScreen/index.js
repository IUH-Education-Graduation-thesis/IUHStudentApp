            ...
            <View style={styles.contentView}>
                <Table >
                    <TableWrapper style={styles.wrapper}>
                        <Col data={table[0].tableTitle} style={styles.title} heightArr={[35, 35, 35, 35, 35, 35, 35, 35, 35, 35]} textStyle={styles.text} />
                        <Col data={student.slice(1)} style={styles.title} heightArr={[35, 35, 35, 35, 35, 35, 35, 35, 35, 35]} textStyle={styles.text} />
                    </TableWrapper>
                </Table>
